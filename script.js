...
function renderData(arrayOfVideos) {
  ...
  arrayOfVideos.forEach((video) => {
    ...
    card.innerHTML = '<div class="cardWrapper">' +
      ...
      '<img class="thumbnail" data-channelId ="' + video.snippet.channelId + '"' + 'data-src="' + video.id.videoId + '"' + '+ src=' + video.snippet.thumbnails.high.url + '>' +
       +
      '</div>' +
...
function setVideoId() {
  let playBtn = document.getElementsByClassName("thumbnail");
